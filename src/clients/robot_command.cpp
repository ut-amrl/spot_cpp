...
namespace ClientLayer {
  ...
  // from the server.
  RobotCommandResponse RobotCommandClient::robotCommand(bosdyn::api::Lease lease, RobotCommand command, std::string &clockIdentifier) {
  ...
  RobotCommandResponse RobotCommandClient::robotCommandAsync(bosdyn::api::Lease lease, RobotCommand command, std::string &clockIdentifier){
    RobotCommandRequest request;
    assembleRequestHeader<RobotCommandRequest>(&request);
    request.mutable_lease()->CopyFrom(lease);
    request.mutable_command()->CopyFrom(command);
  ...
  ClearBehaviorFaultResponse RobotCommandClient::clearBehaviorFault(bosdyn::api::Lease lease, uint32_t behaviorFaultId){
  ...
  ClearBehaviorFaultResponse RobotCommandClient::clearBehaviorFaultAsync(bosdyn::api::Lease lease, uint32_t behaviorFaultId){
    ClearBehaviorFaultRequest request;
    request.mutable_lease()->CopyFrom(lease);
    request.set_behavior_fault_id(behaviorFaultId);
    assembleRequestHeader<ClearBehaviorFaultRequest>(&request);
