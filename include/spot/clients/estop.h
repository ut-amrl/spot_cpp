...
class EstopClient;
  ...
  /*
    class EstopEndpoint: Represents and endpoint in the E-stop system
    // TODO: ADD TO NAMESPACE W/ OTHER CLIENTS TO DIFFERENTIATE FROM PROTOBUF CLASS
  */
  class EstopEndpoint {
  public:
    EstopEndpoint(std::shared_ptr<EstopClient> client, const std::string &name, const std::string &role, const std::string &configId, 
  ...
  public:
    ...
    // change
    RegisterEstopEndpointResponse registerEndpoint(const std::string &targetConfigId, bosdyn::api::EstopEndpoint &endpoint);
    RegisterEstopEndpointResponse registerEndpointAsync(const std::string &targetConfigId, bosdyn::api::EstopEndpoint &endpoint);
  
    // change
    RegisterEstopEndpointResponse replaceEndpoint(const std::string &targetConfigId, bosdyn::api::EstopEndpoint &replaced, bosdyn::api::EstopEndpoint &endpoint);
    RegisterEstopEndpointResponse replaceEndpointAsync(const std::string &targetConfigId, bosdyn::api::EstopEndpoint &replaced, bosdyn::api::EstopEndpoint &endpoint);
    
    // change
    DeregisterEstopEndpointResponse deregister(const std::string &targetConfigId, bosdyn::api::EstopEndpoint &endpoint); 
    DeregisterEstopEndpointResponse deregisterAsync(const std::string &targetConfigId, bosdyn::api::EstopEndpoint &endpoint);
    ...
    // change
    EstopCheckInResponse checkIn(EstopStopLevel &stopLevel, bosdyn::api::EstopEndpoint &endpoint, uint64_t challenge, uint64_t response, bool suppress_incorrect);
    EstopCheckInResponse checkInAsync(EstopStopLevel &stopLevel, bosdyn::api::EstopEndpoint &endpoint, uint64_t challenge, uint64_t response, bool suppress_incorrect);
  };
  ...
  */
  ...
  public:
    ...
    EstopThread(std::shared_ptr<EstopClient> clientPtr, std::shared_ptr<EstopEndpoint> endpoint);
    ~EstopThread();
    ...
    */
    ...
    std::shared_ptr<EstopEndpoint> getEndpoint() const { return _endpoint; }
  ...
  private:
    ...
    std::shared_ptr<EstopEndpoint> _endpoint;
    bool _keepRunning;
  };
